...
@section('content')
    ...
    <form action="{{route('halaman.store')}}" method="POST" class="p-2 row" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan judul berita disini" value="{{old('judul')}}" maxlength="100" required>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="deskripsi" name="deskripsi" class="form-control" placeholder="Masukkan deskripsi berita" value="{{old('meta_description')}}" maxlength="150" required>
                        <span class="fs-6 " id="counter1"></span>
                    </div>
                    <div class="mb-3">
                        <label for="meta_keyword" class="form-label">Keyword <span style="color: red">*</span></label>
                        <input type="text" id="keyword" name="meta_keywords" class="form-control" placeholder="Pisahkan keyword dengan tanda koma (,)" value="{{old('meta_keywords')}}" maxlength="160" required>
